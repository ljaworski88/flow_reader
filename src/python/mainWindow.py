...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sensorSettingsVerticalLayout.addLayout(self.loadSettingsHorizontalLayout)
...
"color: rgb(238, 238, 236);")
        ...
        self.rightTransducerPressureUnitesLineEdit = QtWidgets.QLineEdit(self.rightTransducerSettingsTab)
        self.rightTransducerPressureUnitesLineEdit.setObjectName("rightTransducerPressureUnitesLineEdit")
        self.rightTransducerCalibrationFormLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.rightTransducerPressureUnitesLineEdit)
