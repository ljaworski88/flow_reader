...
"color: rgb(238, 238, 236);")
        ...
        self.condutivityLineEdit = QtWidgets.QLineEdit(self.sensorSettingsTab)
        self.condutivityLineEdit.setObjectName("condutivityLineEdit")
        self.horizontalLayout_3.addWidget(self.condutivityLineEdit)
